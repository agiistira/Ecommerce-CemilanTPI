<main id="main">
    <div class="container">
                ...
                @foreach($sliders as $slider)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            ...
                            <p class="sale-info">Only price: <span class="price">Rp. {{ $slider->price }}</span></p>
        ...
        <!--On Sale-->
        {{-- @if ($sproducts->count() >0 && $sale->status === 'active' && $sale->sale_date > Carbon\Carbon::now('Africa/Cairo'))
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/dom.jpg') }}" width="1170" height="240" alt=""></figure>
                </a>
            </div>
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/domikategori.jpg') }}" width="1170" height="240" alt=""></figure>
                </a>
            </div>
            <div class="wrap-products">
                <div class="wrap-product-tab tab-style-1">
